...
public class createdMyListAdapter extends RecyclerView.Adapter<createdMyListAdapter.ViewHolder> {
    private String[] titles;
    private String[] by;
    private String[] desc;
    public createdMyListAdapter(String[] titles, String[] by, String[] desc) {
        this.titles = titles;
        this.by = by;
        this.desc = desc;
    }
    ...
    @NonNull
    @Override
    public createdMyListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navController.navigate(R.id.action_navigation_createdByMe_to_navigation_myCoursesContent, bundle);
            }
        });
    }
